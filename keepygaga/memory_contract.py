...
from keepygaga.config import DYNAMIC_PAGE_LIMIT as DYNAMIC_PAGE_LIMIT
from keepygaga.config import DYNAMIC_PAGE_LIMITS as DYNAMIC_PAGE_LIMITS
from keepygaga.config import PROFILE_PAGE_LIMIT as PROFILE_PAGE_LIMIT

PREFERENCES_PAGE_LIMIT = PROFILE_PAGE_LIMIT
